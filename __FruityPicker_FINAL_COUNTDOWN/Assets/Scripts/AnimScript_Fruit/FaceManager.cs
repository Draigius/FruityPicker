...
public class FaceManager : MonoBehaviour
{
    ...
    private float timer_secat = 2;
    private float delay_secat = 2;
    ...
    void Start()
    {
        ...
        delay_secat += Random.Range(0f, 1f);
    ...
    void Update()
    {
        ...
        if (hJonctionZone != null && hJonctionZone.GetComponent<Jonction>().iEtat<0)
        {
            FuncOnAngry();
        ...
        if (Input.GetMouseButtonUp(0) == true)
        {
            ...
            if (scriptJonction.bActive == false && scriptJonction.bAttacher == false && Camera.main.GetComponent<MainGame>().bCri == false)
            {
                audioMaster.PlayEvent("Stop_All");
        ...
        if (Camera.main.GetComponent<MainGame>().bCri == true)
        {

            timer_secat += Time.deltaTime;

            if (timer_secat > delay_secat)
            {
                FuncOnChange(true);
