...
public class Proto_TouchScript : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (fBreakLimit >= fBreakLimitMax && rbTouched.GetComponent<HingeJoint>() != null) {
            ...
            {
                if (hTouchedObject.GetComponent<HingeJoint>().tag == "Kiwi") nameScene = "Levels"; Invoke("changeScene", 1.0f);
                if (hTouchedObject.GetComponent<HingeJoint>().tag == "Poire") nameScene = "Credits"; Invoke("changeScene", 1.0f);
                if (hTouchedObject.GetComponent<HingeJoint>().tag == "Citron") nameScene = "Options"; Invoke("changeScene", 1.0f);
            }
        }
