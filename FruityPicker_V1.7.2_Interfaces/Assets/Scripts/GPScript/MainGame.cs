...
public class MainGame : MonoBehaviour
{
    ...
    void funcUpdateUI()
    {
        ...
        textNgrappe.text =  ""+iGrappeRestant;


        if(bPause == false)
        {
            //textTimer.text = Mathf.Floor(fTimerGameDéconte) + "s";

            int _iTimerMinutes = Mathf.CeilToInt(fTimerGameDéconte / 60)-1;
            int _iTimerSeconds = Mathf.CeilToInt(fTimerGameDéconte % 60);
            textTimer.text = "" + _iTimerMinutes + " : " + _iTimerSeconds;
