            ...
            for (int i = 1; i < hMainCam.GetComponent<MainGame>().hTableJunction.Length; i++)
            {
                ...
                if (iIdVerif == hLanceurFonction.GetComponent<Jonction>().iIdParent && iTypeVerif != 1 && iTypeVerif != 2)
                {
                    if (iEtatPropagation >= 0)
                    {
                        ...
                        //hMainCam.GetComponent<MainGame>().hTableJunction[i].GetComponent<HingeJoint>().gameObject.GetComponent<ConectionBras>().iEtatFB = 0;/// feedback join
                    ...
                    else
                    {
                        ...
                        hMainCam.GetComponent<MainGame>().hTableJunction[i].GetComponent<Jonction>().iEtat = hMainCam.GetComponent<MainGame>().hTableJunction[i].GetComponent<Jonction>().iEtat - (1 * iActivation);
                        //hMainCam.GetComponent<MainGame>().hTableJunction[i].GetComponent<HingeJoint>().gameObject.GetComponent<ConectionBras>().iEtatFB = -1;/// feedback join

                    }

                    //hMainCam.GetComponent<MainGame>().hTableJunction[i].GetComponent<HingeJoint>().gameObject.GetComponent<ConectionBras>().bActif = false;/// feedback join
